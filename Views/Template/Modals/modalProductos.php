  ...
  <div class="modal-dialog modal-xl" >
    <div class="modal-content">
      <div class="modal-header headerRegister">
        <h5 class="modal-title" id="titleModal">Nuevo Libro</h5>
              ...
              <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                      <label class="control-label">Titulo del Libro <span class="required">*</span></label>
                ...
                <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="listCategoria">Genero <span class="required">*</span></label>
