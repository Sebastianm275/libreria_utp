...
<div class="modal fade" id="modalRegisto" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      ...
      <div class="modal-body">
             ...
             <div class="tab-pane " id="registro" role="tabpanel" aria-labelledby="profile-tab">
						  	<br>
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						<a href="#" class="flex-c-m trans-04 p-lr-25" data-toggle="modal" data-target="#modalRegisto" >
							Registrarse
						</a>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<a href="<?= base_url(); ?>" class="logo">
						<img src="<?= media() ?>/tienda/images/loggo.png" alt="Tienda Virtual">
					</a>
