				...
				<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-l-25 m-r--38 m-lr-0-xl">
					...
					<?php }else{ ?>
						...
						<ul class="nav nav-tabs" id="myTab" role="tablist">
						  <li class="nav-item">
						    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#login" role="tab" aria-controls="home" aria-selected="true">Advertencia</a>
						  </li>
						...
						<div class="tab-content" id="myTabContent">
						  <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="home-tab">
							  ...
							  <div class="form-group">
							    <label for="txtEmail">Para poder continuar con la compra por favor Inicia Sesion</label>
							...
							<div class="divmetodpago">
								<div>
									<label for="paypal">
										...
										<img src="<?= media() ?>/images/img-paypal.jpg" alt="Icono de PayPal" class="ml-space-sm" width="74" height="20"><span> --> NO IMPLEMENTADO</span>
									</label>
								</div>
								<div>
