...
function fntEditInfo(element,idProducto){
    ...
    document.querySelector('#titleModal').innerHTML ="Actualizar Libro";
...
function fntDelInfo(idProducto){
    swal({
        ...
        text: "¿Realmente quiere eliminar el Libro?",
        type: "warning",
...
function openModal()
{
    ...
    document.querySelector('#titleModal').innerHTML = "Nuevo Libro";
