...
(1, 'Literatura', 'Libros de Literatura', 'img_63f4c6d1bfce377af706d1a47d66d648.jpg', '2021-08-20 03:04:04', 'literatura', 1),
(3, 'Ciencias Básicas', 'Libros de educación sobre Matemáticas, Física, Química...', 'img_66f505a6bd6b7c6671d0cd3bf7f3c6d8.jpg', '2022-10-02 11:12:46', 'ciencias-basicas', 1),
(4, 'Ciencias de la Computación', 'Libros de Ciencias de la Computación', 'img_58ace687d939555a51bfe12c08962eb6.jpg', '2022-10-04 10:50:48', 'ciencias-de-la-computacion', 1);
...
(17, 4, 'pro_9a6c458e6f48b469361389d000dd403a.jpg'),
(18, 5, 'pro_8d78bf4299094104179a9c5577ea277f.jpg'),
(19, 6, 'pro_be8f1d9c455ebb44e8d534a5eac72bb0.jpg');
...
(3, NULL, NULL, NULL, 5, '2022-10-02 10:10:35', '5.00', '905.00', 2, 'la jungla, quien sabe', 'Pendiente'),
...
(1, '24091989', 'Sebastian', 'Menezes', 123456, 'seb.men@gmail.com', 'mantequilla', 'CF', 'Abel OSH', 'Ciudad', NULL, 1, '2021-08-20 01:34:15', 1),
...
(10, 'Registrarse', '<p>registro de usuarios</p>', 'img_4509b44f71f23216b9a8b97b22fdb96a.jpg', '2022-10-03 11:44:05', 'registrarse', 1);
...
CREATE TABLE IF NOT EXISTS `producto` (
  ...
  `nombre` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `autor` varchar(80) COLLATE utf8mb4_swedish_ci NOT NULL,
  `año` varchar(4) COLLATE utf8mb4_swedish_ci NOT NULL,
  `numpaginas` int NOT NULL,
  `editorial` varchar(100) COLLATE utf8mb4_swedish_ci NOT NULL,
  `issn` int NOT NULL,
  `idioma` varchar(30) COLLATE utf8mb4_swedish_ci NOT NULL,
  `fechaPublicacio` varchar(10) COLLATE utf8mb4_swedish_ci NOT NULL,
  `nuevo` int NOT NULL,
  `descripcion` text CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `precio` decimal(11,2) NOT NULL,
  `stock` int NOT NULL,
...
INSERT INTO `producto` (`idproducto`, `categoriaid`, `codigo`, `nombre`, `autor`, `año`, `numpaginas`, `editorial`, `issn`, `idioma`, `fechaPublicacio`, `nuevo`, `descripcion`, `precio`, `stock`, `imagen`, `datecreated`, `ruta`, `status`) VALUES
(4, 3, '343434', 'Serway Jewett Fisica Volumen 2', '', '', 0, '', 0, '', '', 0, '<p>Autor: Raymond Serway&nbsp;</p> <p>A&ntilde;o: 2009</p> <p>Numero de Paginas: 423</p> <p>Editorial: Cengage Learning</p> <p>ISSN:&nbsp; 4564575786</p> <p>Idioma: Espa&ntilde;ol</p> <p>Fecha de Publicacion: 25/08/2009</p> <p>Estado: Nuevo</p>', '5.00', 12, NULL, '2022-10-02 11:18:55', 'serway-jewett-fisica-volumen-2', 1),
(5, 4, '23423456', 'Python Machine Learning', '', '', 0, '', 0, '', '', 0, '<p>Autor: Sebastian Raschka</p> <p>A&ntilde;o: 2018</p> <p>Numero de Paginas: 423</p> <p>Editorial: Marcombo</p> <p>ISSN:&nbsp; 7964584843</p> <p>Idioma: Espa&ntilde;ol</p> <p>Fecha de Publicacion: 14/06/2018</p> <p>Estado: Nuevo</p>', '18.00', 17, NULL, '2022-10-05 14:42:51', 'python-machine-learning', 1),
(6, 1, '56566556', 'El Arte de la Guerra', '', '', 0, '', 0, '', '', 0, '<p>Autor: Sun Tzu</p> <p>A&ntilde;o: 2018</p> <p>Numero de Paginas: 160</p> <p>Editorial: Fontana</p> <p>ISSN:&nbsp; 7964584843</p> <p>Idioma: Espa&ntilde;ol</p> <p>Fecha de Publicacion: 11/05/2010</p> <p>Estado: Nuevo</p>', '34.00', 0, NULL, '2022-10-05 15:05:28', 'el-arte-de-la-guerra', 1);
...
(2, 'Sebastian Menezes', 'sebastian.menezes@utp.edu.co', '2022-10-02 10:04:03');
